...
/**
 * Implementation of [DailyCompletionCheckScheduler] using Android's WorkManager
 * to schedule a daily task for checking uncompleted habits.
 * This class handles the initial scheduling of the [UncompletedHabitsWorker].
 * The worker itself is responsible for its subsequent rescheduling.
 */
@Singleton
